...
from aegis.sensor.decoders import DecodedResult
...
@dataclass
class EngineConfig:
    """Configuration for the ADR-AEGIS engine.
...
class ADRAegisEngine:
    """Main orchestration engine for ADR-AEGIS threat detection.
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize the ADR-AEGIS engine.
