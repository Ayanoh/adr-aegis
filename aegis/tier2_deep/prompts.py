...
from aegis.core.schema import ExtractedArtifacts, Tier2Assessment, Tier2Input

FORENSIC_SYSTEM_PROMPT = (
    "You are the Forensic Analyst of ADR-AEGIS, a security system that guards AI agents. "
...
CRITIC_SYSTEM_PROMPT = (
    "You are the Critic of ADR-AEGIS's dual-agent deep reasoner. A Forensic Analyst produced an "
